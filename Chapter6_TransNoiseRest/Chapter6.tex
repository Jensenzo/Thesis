...
\begin{tabular}{|l|c|c|c|c|c|}\hline
                    % file 3    & file 2    & file 1    & file 4
                    & set 2     & set 4     & set 6     & set 11    & Mean      \\ \hline
  Reconstruction    & 77.7 dB   & 88.5 dB   & 87.0 dB   & 88.9 dB   & 85.5 dB   \\
  Original          & 78.5 dB   & 88.7 dB   & 81.6 dB   & 85.7 dB   & 83.6 dB   \\ \hline
  Difference        & -0.8 dB   & -0.2 dB   & 5.4  dB   & 3.2  dB   & 1.9  dB   \\
  \hline
\end{tabular}\end{center}\end{table}
