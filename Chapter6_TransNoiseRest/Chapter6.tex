...
\begin{tabular}{|l|c|c|c|c|c|}\hline
  ...
  Filtering w. noise (waveform) & 1.8 $\ttt{-3}$    & 0.0 $\ttt{-3}$    & 2.9 $\ttt{-3}$    &  0.0 $\ttt{-3}$  \\
...
A series of waveforms are in this section represented to visualise the performance of the reconstruction algorithms' performance. While not necessarily a complete 
\todo{do text}
