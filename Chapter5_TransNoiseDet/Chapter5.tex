...
\subsection{Detection results method} %A note about the issues of plotting/decribing/comparing detection results.
\todo{Write about quantifying detection results and the ambiguity of detections.}
