...
\subsection{Detection results} %A note about the issues of plotting/decribing/comparing detection results.
...
\todo{Test results from table were actually AR filter}
