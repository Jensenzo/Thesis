...
y_n = \sum^P+{k=1} a_k x_{n-k} + e_n + d_n.
\end{equation}
...
% \nonumber to remove numbering (before each equation)
  v_n &=& y_n - \sum^P+{k=1} \hat{a}_k y_{n-k} \nonumber\\
  &=& x_n + d_h - \sum^P+{k=1} (a_k - \tilde{a}_k)(x_{n-k} + d_{n-k}),\label{eq:Vaseghi1990_6}
\end{eqnarray}
...
v_n = e_n + d_h - \sum^P+{k=1} \hat{a}_k d_{n-k} + \sum^P+{k=1} \tilde{a}_k x_{n-k}.
\end{equation}
