...
from language identification \cite{Nagarajan2004}, is a recursive optimal solution to the problem of estimating the state sequence of a discrete-time finite-state Markov process \cite{Forney1973}.
