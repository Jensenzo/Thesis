...
Specific keystroke removal systems were proposed in a couple of articles \cite{Subramanya2007}\cite{Sugiyama2007}\cite{Sugiyama2013}\cite{Seltzer2011Patent}. While some implementations propose real time implementations, none offer methods utilizing lookahead less than 10 or 20 ms and without the reliance of and \gls{os} cue.
% ------------------------------------------------------------------------
