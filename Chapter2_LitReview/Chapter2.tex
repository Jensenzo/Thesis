...
\subsubsection{Autoregressive (AR) methods}\label{sec:LitRevAR}
...
% AR \cite{Janssen1986}
% P. A. A. Esquef, L. W. P. Biscainho, V. Välimäki, and M. Karjalainen, "Removal of Long Pulses from Audio Signals Using Two-pass Split-Window Filtering", presented at the 112th AES Convention, preprint no. 5535, Munich, Germany, May 10-13, 2002.
...
%An Efficient Model-Based Method for Reconstruction of Audio Signals Across Long Gaps \cite{Esquef2006} (based on \cite{Kauppinen2002a})
