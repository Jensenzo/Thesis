...
Similar to further word presented in chapter~\ref{ch:APR} it may be possible to correlate components trained through different channels at the same spot or conversely correlate $\theta$.
